...
class GraspObject():
	...
	self.sub3 = rospy.Subscriber('/pos', String, self.toPos, queue_size=1)
        # 发布机械臂位姿
    ...
    def image_cb(self, data):
        ...
        # 蓝色物体颜色检测范围
        LowerBlue = np.array([95, 90, 80])#[95,90,80]
    ...
    def release_object(self):
        r1 = rospy.Rate(0.1)  # 5s 0.15
        r2 = rospy.Rate(1)     # 1s 1
        pos = position()
        # go forward
        #pos.x = 250
        #pos.y = 0
